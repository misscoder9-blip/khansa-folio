...
export default function Testimonial({ testimonials, autoPlayInterval = 5000 }: TestimonialProps) {
  ...
  return (
    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          {/* Logo column */}
          {/* <div className="flex flex-col items-center justify-center shrink-0 w-[100px]"> */}
          {/* <div className="flex flex-col items-center justify-center shrink-0 w-[100px]">
            <Image
              src={t.logo}
            ...
            {t.company && (
              <p
                className="text-[20px] text-[#070707] mt-3 whitespace-nowrap text-center"
  ...
  {t.company && (
    ...
    >
      {t.company}
          ...
          {/* Content column */}
          {/* <div className="flex flex-1 flex-col justify-between min-w-0 gap-4" style={{ minHeight: '220px' }}> */}
          <div
...
>
            ...
            <div className="flex flex-col gap-[8px] ">
              ...
              <p className="text-[18px] font-medium text-start text-[#070707]" style={{ fontFamily: 'var(--font-satoshi)' }}>
...
{/* fine for all screen just issue in border  */}

            {/* <div className="flex flex-col gap-[8px] sm:items-start items-start">
  

  <p
    // className="text-[18px] font-medium text-[#070707] text-left block md:hidden border-t border-b border-dashed border-[#cfd1d4] mt-2 w-full"
    // className="text-[18px] font-medium text-[#070707] text-left block md:hidden border-t border-b border-dashed border-[#cfd1d4] py-[6px] md:py-[0] w-full"
    className="text-[18px] font-medium text-[#070707] text-left border-t border-dashed border-[#cfd1d4] border-b md:border-b-0 py-[2px] md:py-0 w-full"
    style={{ fontFamily: 'var(--font-satoshi)' }}
  >
    My Role: {t.roleNormal}
    <span
  ...
  <div className="border-t border-dashed border-[#cfd1d4]" />
            ...
            {/* <div className="block md:hidden border-t border-dashed border-[#cfd1d4]" /> */}
            <p
